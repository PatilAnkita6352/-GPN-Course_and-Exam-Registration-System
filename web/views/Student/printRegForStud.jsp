<%-- 
    Document   : printRegForStud
    Created on : Mar 3, 2019, 12:03:59 AM
    Author     : Shubham Nehe
--%>
    ...
    <% if(session.getAttribute("stud_uname")==null || session.getAttribute("stud_user")==null)
      ...
      {  
          %><jsp:include page="../headerforallPanelviews.jsp"/><%
              System.out.print("****************   PRINTREGFORSTUD.JSP  *******************");
        ...
        List listEx=StudCon.getExRegCourse((String)session.getAttribute("stud_uname"),stud.getTerm(),new Integer(stud.getYear()));
    %>  
        <div class="container"> 
              ...
              <!--Printing student details--> 
                <div class="row">
                    ...
                    <div class="col-sm-4" style="float:right;">
                          <h5> 
                              Roll No. : <%=(String)session.getAttribute("stud_uname") %><br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <table border="1" text-align="center">
                            ...
                            <% 
                               List list=StudCon.getRegularRegCourses((String)session.getAttribute("stud_uname"),stud.getTerm(),new Integer(stud.getYear()));
                               List list1=StudCon.getBacklogRegCourses((String)session.getAttribute("stud_uname"),stud.getTerm(),new Integer(stud.getYear()));
                ...
                <br><center><b>CERTIFICATE</b></center><br>
                <div class="row">
                ...
                <div class="row">                         
                       <form method="post">  
                           <div class="col-sm-2">      
                                <input type="button" id="printBtn" value="Print" onClick="printpageCourse()" class="btn btn-lg btn-primary pull-left"> 
                           </div> 
                           <div class="col-sm-3">
                                <button id="homeBtn" value="Home" formaction="studPanel.jsp" class="btn btn-lg btn-primary">Home</button>
                           </div>
                       </form> 
                </div> 
              ...
              <!--Printing student details--> 
                    ...
                    <div class="col-lg-10">
                        <table border="1" text-align="center">
                            ...
                            <tr> 
                                ...
                                <td><%if(exreg.getEx_back()!=1){out.print("X");}else{out.print("Y");}%></td> 
                            </tr>
                            <%
                                } 
                            %>
               ...
               &nbsp&nbsp&nbsp&nbsp 5. Student's can registered for Examination of Maximum <%= ad.getMax_reg_courses() %> courses.<br>
                ...
                <div class="row">                         
                       <form method="post">  
                           <div class="col-sm-2">      
                                <input type="button" id="printBtn1" value="Print" onClick="printpageExam()" class="btn btn-lg btn-primary pull-left"> 
                           </div> 
                           <div class="col-sm-3">
                                <button id="homeBtn1" value="Home" formaction="studPanel.jsp" class="btn btn-lg btn-primary">Home</button>
                           </div>
                       </form> 
                </div> 
                </div>  
